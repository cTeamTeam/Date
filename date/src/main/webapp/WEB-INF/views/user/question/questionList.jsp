...
<%@include file="/WEB-INF/views/user/common/header.jsp" %>
    ...
    <div class="qaSearch">
    	<form name="searchForm" method="get" action="/date/qaSearch?keyword=${document.searchForm.keyword.value}">
 			 ...
 			 </select>&nbsp;&nbsp;	<input class="qaSearchInput" type="text" name="keyword" id="keyword">
 			 <span>
 			 	<button class="qaButton" type="button" onclick="searchCheck()">검색</button>
 			 </span>   	
    	</form>
    </div>
    ...
    <table style="margin-top:60px; margin:auto;">
    	<c:if test="${empty questionList }">
    		...
    		<tr>
    			<td colspan="5" class="qaNot">등록된 Q&A가 없습니다</td> 
    		</tr>
    	</c:if>
 		<c:if test="${!empty questionList }">
 			<tr>
